...
{section var=PersistentData show=$browse.persistent_data loop=$browse.persistent_data}
    {if $PersistentData.key|ne( 'ExportSources' )}
...
<div class="block">
    ...
    {if $browse.action_name|eq( 'BrowseXMLExport' )}
        <input class="button" type="submit" name="BrowseCancelButton" value="{'Clear all selected nodes'|i18n( 'design/admin/ezxmlexport' )}" />
    {else}
